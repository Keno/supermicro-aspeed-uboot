...
ast2300_fpga_1_config :	unconfig
	@./mkconfig $(@:_config=) arm arm926ejs ast2300_fpga_1 NULL ast2300_fpga_1

ast2300_fpga_2_config :	unconfig
	@./mkconfig $(@:_config=) arm arm926ejs ast2300_fpga_2 NULL ast2300_fpga_2

ast2100_config :	unconfig
	@./mkconfig $(@:_config=) arm arm926ejs ast2100 NULL ast2100

ast1100_config :	unconfig
	@./mkconfig $(@:_config=) arm arm926ejs ast1100 NULL ast1100
	
ast2300_config :	unconfig
	@./mkconfig $(@:_config=) arm arm926ejs ast2300 NULL ast2300
