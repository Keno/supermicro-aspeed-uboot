...
#define CONFIG_BOOTCOMMAND	"bootm " toStr(81000000)
#else
...
#define PHYS_SDRAM_1_SIZE	0x8000000 	/* 128MB */  
...
#ifdef CONFIG_FLASH_AST2300
#define PHYS_FLASH_1			FLASH_BASE_ADDR //0x20000000 	/* Flash Bank #1 */
#else
...
#define CONFIG_ENV_OFFSET		BOOTLOADER_ENV_OFFSET//0xFE0000 	/* environment starts here  */
#define CONFIG_ENV_SIZE			BOOTLOADER_ENV_SIZE//0x020000 	/* Total Size of Environment Sector */
...
#define CONFIG_ENV_IS_IN_FLASH		1
#define CONFIG_ENV_OFFSET		BOOTLOADER_ENV_OFFSET//0x7F0000 	/* environment starts here  */
#define CONFIG_ENV_SIZE			BOOTLOADER_ENV_SIZE//0x010000 	/* Total Size of Environment Sector */
#else
#define CONFIG_SYS_FLASH_BASE		PHYS_FLASH_1
#define CONFIG_FLASH_BANKS_LIST 	{ PHYS_FLASH_1 }
#define CONFIG_SYS_MAX_FLASH_BANKS 	1
...
#define CONFIG_KCS_SUPPORT

#ifdef  CONFIG_KCS_SUPPORT
#define CONFIG_USE_IRQ				
#define CONFIG_INT_ENABLED		
#define KCS_PHY_ADDR			0x0CA20CA3
#endif
