...
#define ADDRESS_4BYTES		0x00002000
/* ~AST2300 only */
...
*/
	...
	if (info->size > 0x200000)	/* limit MAX Flash to 2MB for AST1300 */
	    info->size = 0x200000;
#endif
#if	defined(CONFIG_FLASH_AST2300) || defined(CONFIG_AST2300_FPGA_1) || defined(CONFIG_AST2300_FPGA_2) || defined(CONFIG_AST1300)
	...
	/* unprotect flash */	
        ...
        if (info->address32)	
            enable4b(info);			/* enable 32bits addressing */
